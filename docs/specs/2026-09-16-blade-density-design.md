...
Wrap, because a blade means nothing outside a cabinet.
...
Ranges line is `rack1: c[1-40]`, one name on the left and a hostlist of *nodes*
on the right, while a blade line is `rack[1-120]: 2`, a hostlist of *groups*
on the left and a count on the right. In both the left says who and the right
