...
module.exports = defineConfig(
  globalIgnores([
    ...
    'tests/contract/*.cjs',
    // Owned and regenerated by `@grafana/create-plugin`, not by this repo:
    // each plugin's own eslint.config.mjs (extending @grafana/eslint-config)
    // already lints it on its own terms, and its own CLAUDE.md forbids
    // editing anything under .config/. Holding generated tooling code to
    // this repo's stricter typescript-eslint ruleset would fail on files we
